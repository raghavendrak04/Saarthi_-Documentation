            ...
            {isOpen && (
                ...
                >
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        ...
                                        color: message.role === 'user' ? 'white' : 'var(--gray-900)',
                                        border: message.role === 'user' ? 'none' : '1px solid var(--gray-200)',
                                    }}
                                >
                    ...
                    >
                        ...
                        <p style={{ fontSize: '0.75rem', color: 'var(--gray-400)', marginTop: '0.5rem', textAlign: 'center', margin: '0.5rem 0 0 0' }}>
