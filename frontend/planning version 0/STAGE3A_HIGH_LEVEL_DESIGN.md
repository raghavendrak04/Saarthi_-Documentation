...
**Pattern**: Monolithic Client-Server Architecture (React + Express)
...
┌───────────────────────────────┴─────────────────────────────────┐
│                        EXPRESS BACKEND                           │
│              (Node.js + Express.js app.ts)                       │
│                                                                 │
│   ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐ ┌────────┐      │
│   │  Auth  │ │   AI   │ │ Course │ │  Chat  │ │  User  │      │
...
│  │ (Mongoose/InM)│        │   (Optional)     │                  │
│  └───────────────┘        └──────────────────┘                  │
└─────────────────────────────────────────────────────────────────┘
```

## 1.2 Module Breakdown (Monolith)
...
└── Router
    ...
    └── ProtectedRoutes (RequireAuth wrapper)
        ...
        │
        ├── CourseDetail
        │   ├── StreamTab (Announcements, Create Post)
        │   ├── ClassworkTab (Material, Quizzes, Categories)
        │   └── PeopleTab (Teachers, Classmates - Admin Only)
        │
        ├── VideoPlayerPage
        │   ├── CustomControls
        │   ├── AnnotationsOverlay
