...
- Edit fields: Full Name, Institute, Bio, Profile Picture
- Student-specific fields: Working Department (CSE/ECE/AI&ML), Contact Number, Admission Number (Hidden from Admins)
- Cannot edit: Email (requires re-verification if changed)
- Save changes with validation
- Success/error notifications
- Appearance settings including Theme Toggle (Light / Dark / Auto)
...
- Theme Toggle component (Sun/Moon icon) present in header navigation
...
**Acceptance Criteria**:
- Google Classroom style tabs interface: "Stream", "Classwork", "People"
- **Stream Tab**: Displays announcements, new material notifications, and course banner
  - Teacher/Admin can compose new announcements with rich attachments
- **Classwork Tab**: Structured curriculum divided by Topics (e.g., Video Lectures, Course Materials)
  - Teacher/Admin has a "Create" menu for Assignments, Materials, Video Lectures, and Topics
- **People Tab**: Display list of Teachers and Classmates
  - Hidden from Student roles, visible only to Admins/Teachers
- Progress indicators for each module or global progress bar
...
**Microservices / Monolithic Backend Structure**:
```
backend/
├── src/
...
│   └── app.ts           # Express setup & DB connection
```

**API Design Patterns**:
- RESTful APIs for CRUD operations
- Local In-Memory MongoDB (during development) for quick prototyping
